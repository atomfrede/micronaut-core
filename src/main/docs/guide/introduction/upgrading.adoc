...
For Micronaut 2.0, we recommend you to use the native Micronaut-based transaction management instead of other alternatives such as Spring Transaction Mangement.

You will use https://docs.oracle.com/javaee/7/api/javax/transaction/Transactional.html[Java EE 7 javax.transaction.Transactional annotation] and https://micronaut-projects.github.io/micronaut-data/latest/api/index.html[io.micronaut.transaction.annotation.ReadOnly] to mark your transaction demarcations.
